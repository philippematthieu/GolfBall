...
public class Simu {
	...
	public static void main(String[] args) {
		...
		sac[4]  = new Club("F6",  0.200 , 20.0, 26   , 0.83 ,  355.00 , 		420.0 , 		0.54, 	125.5, 	 0.0,	 			0.0,			-5.0);
		sac[5]  = new Club("F7",  0.200 , 20.0, 30   , 0.83 ,  380.00 , 		420.0 , 		0.54, 	122.3, 	 0.0,	 			0.0,			-6.5);
		sac[6]  = new Club("F8",  0.200 , 20.0, 34.5 , 0.83 ,  340.00 , 		420.0 , 		0.53, 	120.0, 	 0.0,	 			0.0,			-8.0);
